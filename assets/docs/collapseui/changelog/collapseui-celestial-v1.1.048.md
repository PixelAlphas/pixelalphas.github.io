### Celestial (v1.1.048) - Released!
Another Update is out! There's be little more patches in the future!<br><br>
...
> **Changes —**
- Added Support `1.21.120` Update! - This means that settings and gameplay are also updated, **`1.21.110` are still supported!**
...
- Fixed wrong links on Collapse-UI